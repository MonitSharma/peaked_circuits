...
the byte-preserved QASM at
`results/tracker_submissions/p12/quantum/source/peaked_circuit_P12_Hqap_98x2457.qasm`. SHA-256:
...
[`results/tracker_submissions/p12/solution_summary.md`](../../results/tracker_submissions/p12/solution_summary.md).
