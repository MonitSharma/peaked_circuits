...
class ReadinessState(StrEnum):
    ...
    READY_FOR_HARDWARE_PREFLIGHT = "READY_FOR_HARDWARE_PREFLIGHT"
    DISCOVERY_CANDIDATE_FROZEN = "DISCOVERY_CANDIDATE_FROZEN"
    CONFIRMATION_PENDING = "CONFIRMATION_PENDING"
    READY_FOR_EXPLICITLY_AUTHORIZED_HARDWARE_RUN = "READY_FOR_EXPLICITLY_AUTHORIZED_HARDWARE_RUN"
    HARDWARE_BATCH_ACTIVE = "HARDWARE_BATCH_ACTIVE"
    HARDWARE_BATCH_RETRIEVED = "HARDWARE_BATCH_RETRIEVED"
