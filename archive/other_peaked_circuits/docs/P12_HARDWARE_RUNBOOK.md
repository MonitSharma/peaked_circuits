...
1. Run `./.venv/bin/python -m p12_recovery.cli hardware-preflight --batch batch_001 --shots 400`. This is a structural preflight: it can pass while `hardware_submission_authorized_by_user=false`.
