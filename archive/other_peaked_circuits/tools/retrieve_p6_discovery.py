#!/usr/bin/env python3
"""Retrieve and preserve the completed P6 discovery result."""
...
JOB_ID = "19c66922-84e0-4f78-99a7-5392f98a4143"
    ...
    record.update(
        {
            ...
            "status": "RETRIEVED",
            "notes": "Raw provider result preserved unchanged. Run target-blind discovery analysis before any candidate comparison or confirmation submission.",
        }
    )
