# P11 classical-method history

This folder preserves the classical research branch’s P11 planning, audits,
and method-exhaustion reports before the successful Helios-1 hardware
...
Use these documents as the starting points:

- [Complete classical status](P11_CLASSICAL_COMPLETE_STATUS.md)
- [Method-exhaustion audit](P11_METHOD_EXHAUSTION_AUDIT.md)
- [Final classical report](P11_FINAL_CLASSICAL_REPORT.md)
- [Extraction report](P11_EXTRACTION_REPORT.md)
- [Unscrambler report](P11_UNSCRAMBLER_REPORT.md)
- [State and next steps](P11_STATE_AND_NEXT_STEPS.md)
